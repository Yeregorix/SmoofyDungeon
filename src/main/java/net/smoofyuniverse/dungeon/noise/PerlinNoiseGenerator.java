package net.smoofyuniverse.dungeon.noise;
...
public class PerlinNoiseGenerator extends NoiseGenerator {
	...
	public double noise(double x, double y, double z) {
		...
		return lerp(fZ,
				lerp(fY, lerp(fX, grad(this.perm[AA], x, y, z), grad(this.perm[BA], x - 1, y, z)),
						lerp(fX, grad(this.perm[AB], x, y - 1, z), grad(this.perm[BB], x - 1, y - 1, z))),
				lerp(fY, lerp(fX, grad(this.perm[AA + 1], x, y, z - 1), grad(this.perm[BA + 1], x - 1, y, z - 1)),
						lerp(fX, grad(this.perm[AB + 1], x, y - 1, z - 1), grad(this.perm[BB + 1], x - 1, y - 1, z - 1))));
	}
